...
PYTHONPATH="$PARENT_DIR/training:$PYTHONPATH" accelerate launch --config_file accelerate_configs/multi_gpu_deepspeed_zero2.yaml --main_process_port 29502 training/train.py config=configs/train_easy_geo.yaml
